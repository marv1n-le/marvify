      ...
      <div className="max-w-2xl sm:py-6 mx-auto">
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <form className="space-y-4" onSubmit={e => toast.promise(
            handleSaveProfile(e), {loading: "Saving...", success: "Profile updated successfully!", error: "Failed to update profile."}
          )}>
            {/* Profile Picture */}
            ...
            <div className="flex justify-end space-x-3 pt-6">
              ...
              <button
                type="submit"
                className="px-4 py-2 border bg-linear-to-r from-indigo-500 to-purple-600 text-white rounded-lg hover:from-indigo-600 hover:to-purple-700 transition cursor-pointer"
              >
                Save Changes
              </button>
            </div>
