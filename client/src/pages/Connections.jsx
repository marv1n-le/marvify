      ...
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-600">
            Manage your network and discorver new connections
          </p>
        </div>
                  ...
                  <div className="flex max-sm:flex-col gap-2 mt-4">
                    {
                      <button
                        ...
                        className="w-full p-2 text-sm rounded bg-linear-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-white active:scale-95 transition cursor-pointer"
                      >
                        View Profile
                      </button>
                    }
