    ...
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="flex flex-col flex-1 items-start justify-between p-6 md:p-10 lg:pl-40">
        <img
          src={assets.logo}
          alt=""
          className="h-28 -mt-6 md:-mt-8 object-contain"
        />
        <div>
          ...
          <p className="text-xl md:text-3xl text-indigo-900 max-w-full md:max-w-2xl leading-relaxed">
            connect with global community on marvify.
          </p>
        </div>
